/* Generated By:JavaCC: Do not edit this line. AbhiLangTokenManager.java */
import visitor.*;
import syntaxtree.*;
import java.util.Vector;

public class AbhiLangTokenManager implements AbhiLangConstants
{
...
private static final int jjStopStringLiteralDfa_0(int pos, long active0)
{
   switch (pos)
   {
      ...
      case 2:
         ...
         return -1;
      case 3:
         if ((active0 & 0x1c204000000L) != 0L)
            return 2;
         if ((active0 & 0x63c9b000000L) != 0L)
         {
            jjmatchedKind = 44;
            jjmatchedPos = 3;
            return 2;
         ...
         return -1;
      case 4:
         if ((active0 & 0x20012000000L) != 0L)
            return 2;
         if ((active0 & 0x43c89000000L) != 0L)
         {
            jjmatchedKind = 44;
            jjmatchedPos = 4;
            return 2;
...
static private final int jjMoveStringLiteralDfa1_0(long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         return jjMoveStringLiteralDfa2_0(active0, 0x40180000000L);
      case 102:
         if ((active0 & 0x20000000L) != 0L)
      ...
      case 111:
         return jjMoveStringLiteralDfa2_0(active0, 0x10001000000L);
      case 114:
...
static private final int jjMoveStringLiteralDfa2_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 105:
         return jjMoveStringLiteralDfa3_0(active0, 0x34200000000L);
      case 108:
...
static private final int jjMoveStringLiteralDfa3_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 108:
         return jjMoveStringLiteralDfa4_0(active0, 0x20401000000L);
      case 110:
...
"\133", "\135", "\73", "\54", "\56", "\74", "\41", "\46\46", "\53", "\55", "\52", 
"\75", "\142\157\157\154\145\141\156", "\143\154\141\163\163", "\145\154\163\145", 
"\145\170\164\145\156\144\163", "\146\141\154\163\145", "\151\146", "\151\156\164", 
"\154\145\156\147\164\150", "\156\145\167", "\155\141\151\156", "\160\165\142\154\151\143", 
"\123\171\163\164\145\155\56\157\165\164\56\160\162\151\156\164\154\156", "\163\164\141\164\151\143", "\123\164\162\151\156\147", "\164\150\151\163", 
"\164\162\165\145", "\166\157\151\144", "\167\150\151\154\145", "\162\145\164\165\162\156", null, 
null, };
...
public AbhiLangTokenManager(SimpleCharStream stream)
{
   if (input_stream != null)
      throw new TokenMgrError("ERROR: Second call to constructor of static lexer. You must use ReInit() to initialize the static variables.", TokenMgrError.STATIC_LEXER_ERROR);
   input_stream = stream;
}
public AbhiLangTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
