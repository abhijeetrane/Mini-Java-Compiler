...
public void visit(ClassDeclSimple n) {
   this.currClass=new ClassSymbolTable(n.f1.f0.tokenImage);
   symTable.addClass(currClass);
   n.f0.accept(this);
   n.f1.accept(this);
   n.f2.accept(this);
   n.f3.accept(this);
...
public void visit(VarDecl n) {
  	...
  	Variable v=new Variable(n.f1.f0.tokenImage,n.f0.f0.which);
  	
   if(currMethod == null){
   	 if(!currClass.addVar(v)){
   	 	ErrorMsg.complain(n.f1.f0.tokenImage+" is already defined in "+currClass.className);
   	    ErrorMsg.complain("+++++Line Number :"+n.f1.f0.beginLine);
   	 }
   	 }else{ if(currMethod.addVar(v))
   	       	  currMethod.localist.add(v);  	
          else{
        ErrorMsg.complain(n.f1.f0.tokenImage+" is already defined in "+currClass.className+"."+currMethod.methodName);	
//        System.out.println("****)
        ErrorMsg.complain("*****Line Number :"+n.f1.f0.beginColumn);  
          }
          }
   n.f0.accept(this);
   n.f1.accept(this);
...
public void visit(MethodDecl n) {
	this.currMethod=new MethodSymbolTable(n.f2.f0.tokenImage,n.f1);
    this.currClass.addMethod(this.currMethod);
...
if(currMethod.addVar(v))
   currMethod.paramlist.add(v);
else
ErrorMsg.complain(n.f1.f0.tokenImage+"is already defined in "+currClass.className+"."+currMethod.methodName);
   n.f0.accept(this);
   n.f1.accept(this);
...
public void visit(FormalRest n) {
	Variable v=new Variable(n.f2.f0.tokenImage,n.f1.f0.which);
	 	
if(currMethod.addVar(v))
currMethod.paramlist.add(v);
else
ErrorMsg.complain(n.f2.f0+" is already defined in "+currClass.className+"."+currMethod.methodName);
